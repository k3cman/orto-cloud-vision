      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4">
            {steps.map((step, index) => <div key={step.number} className="flex items-center flex-1 w-full">
                <motion.div initial={{
              opacity: 0,
              scale: 0.8
            }} whileInView={{
              ...
              delay: index * 0.2
                  ...
                  <div className="relative">
                    <div className="w-20 h-20 rounded-full flex items-center justify-center shadow-soft bg-primary-foreground">
