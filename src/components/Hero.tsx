...
const Hero = () => {
  return <section className="min-h-screen pt-20 bg-background relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          ease: "easeOut"
            ...
            <div className="space-y-4">
              ...
              delay: 0.2
                ...
                <span className="italic font-serif">Više</span> od snimka.
                <br />
          ...
          delay: 0.3
            ...
            <div className="relative">
              ...
              <motion.img src={heroImage} alt="Dental professional holding X-ray tablet" className="relative z-10 max-w-full h-auto max-h-[600px] object-contain drop-shadow-2xl" animate={{
              y: [0, -10, 0]
            }} transition={{
              duration: 6,
              repeat: Infinity,
